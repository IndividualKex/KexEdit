...
KexEdit-aware extension layer bridging the domain-agnostic KexEdit.Graph with the node schema.
...
├── KexEdit.Graph.Typed.asmdef   # Assembly definition
...
- `KexEdit.Graph` - Domain-agnostic graph struct
- `KexEdit.Sim.Schema` - NodeSchema, NodeType, PortSpec, PortDataType
