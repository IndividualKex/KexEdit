...
namespace KexEdit.Legacy.Editor {
    public static class TrackDataExporter {
        ...
        private static TrackDataSection ExtractSectionData(EntityManager entityManager, Entity nodeEntity) {
            ...
            if (entityManager.HasBuffer<Point>(nodeEntity)) {
                ...
                if (points.Length > 0) {
                    section.Outputs.TotalLength = points[^1].Value.TotalHeartLength;
                }
            }
        ...
        private static TrackDataPoint ToPointDataDto(PointData p) {
            float effectiveFrictionDistance = p.TotalHeartLength - p.FrictionCompensation;
            ...
            return new TrackDataPoint {
                HeartPosition = ToVec3(p.Position),
                ...
                SpineArc = p.TotalLength,
                HeartArc = p.TotalHeartLength,
    ...
    public class TrackDataPoint {
        public TrackDataVec3 HeartPosition;
