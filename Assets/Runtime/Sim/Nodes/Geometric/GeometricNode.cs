...
namespace KexEdit.Sim.Nodes.Geometric {
    ...
    public static class GeometricNode {
        ...
        public static void Build(
            ...
            if (config.DurationType == DurationType.Time) {
                ...
                BuildDistanceSection(
                    config.Duration, driven, steering, anchorSpineArc,
                    in rollSpeed, in pitchSpeed, in yawSpeed,
                    in drivenVelocity, in heartOffset, in friction, in resistance,
                    anchorHeart, anchorFriction, anchorResistance,
                    ref state, ref accumulatedRoll, ref result
        ...
        private static void StepGeometric(
            ...
            float3 prevHeartPosition = prev.HeartPosition;

            float3 currDirection;
            float3 currLateral;
            float3 currNormal;
            float3 currHeartPosition;
            ...
            if (steering) {
                ...
                currHeartPosition = prevHeartPosition
                ...
                float3 currSpinePosIfHeartStatic = prevHeartPosition + currNormal * heartOffsetVal;
            ...
            if (!driven) {
                float prevCenterY = (prevHeartPosition + 0.9f * heartOffsetVal * prev.Normal).y;
