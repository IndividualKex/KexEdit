...
namespace Tests {
    ...
    public class KeyframeConversionTests {
        ...
        public void ToCore_PreservesAllFields() {
            ...
            Assert.AreEqual(KexEdit.Core.InterpolationType.Bezier, core.InInterpolation);
            Assert.AreEqual(KexEdit.Core.InterpolationType.Linear, core.OutInterpolation);
        ...
        public void ToLegacy_PreservesAllFields() {
            var core = new KexEdit.Core.Keyframe(
                time: 1.5f,
                value: 2.5f,
                inInterpolation: KexEdit.Core.InterpolationType.Bezier,
                outInterpolation: KexEdit.Core.InterpolationType.Linear,
                inTangent: 0.5f,
                outTangent: -0.5f,
                inWeight: 0.3f,
                outWeight: 0.4f
        ...
        public void RoundTrip_PreservesCoreFields() {
            var original = new KexEdit.Core.Keyframe(
                time: 3.0f,
                value: -1.5f,
                inInterpolation: KexEdit.Core.InterpolationType.Constant,
                outInterpolation: KexEdit.Core.InterpolationType.Bezier,
                inTangent: 1.0f,
                outTangent: 2.0f,
                inWeight: 0.2f,
                outWeight: 0.8f
