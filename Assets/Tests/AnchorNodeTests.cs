...
namespace Tests {
    ...
    public class AnchorNodeTests {
        ...
        public void Build_DefaultPosition_ReturnsValidPoint() {
            ...
            AnchorNode.Build(in position, 0f, 0f, 0f, velocity, 1.1f, 0f, 0f, out Point result);
        ...
        public void Build_WithRotation_ProducesOrthonormalFrame() {
            ...
            AnchorNode.Build(in position, 0.1f, 0.2f, 0.3f, velocity, 1.1f, 0f, 0f, out Point result);
        ...
        public void Build_ZeroArcAndFriction() {
            ...
            AnchorNode.Build(in position, 0f, 0f, 0f, 1f, 1.1f, 0f, 0f, out Point result);
        ...
        public void Build_StoresPhysicsParams() {
            ...
            AnchorNode.Build(in position, 0f, 0f, 0f, 10f, 1.5f, 0.02f, 0.001f, out Point result);
