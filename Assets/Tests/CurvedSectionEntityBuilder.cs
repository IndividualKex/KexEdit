...
namespace Tests {
    public static class CurvedSectionEntityBuilder {
        public static Entity Create(EntityManager em, GoldSection section) {
            ...
            em.SetComponentData(entity, ToCurveData(section.inputs.curveData));
        ...
        private static CurveData ToCurveData(GoldCurveData data) {
