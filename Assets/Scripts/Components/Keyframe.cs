...
namespace KexEdit {
    ...
    public struct Keyframe {
        ...
        private static void LoadDefaults() {
            ...
            _defaultInInterpolation = (InterpolationType)PlayerPrefs.GetInt(PREF_DEFAULT_IN_INTERPOLATION, (int)InterpolationType.Bezier);
            _defaultOutInterpolation = (InterpolationType)PlayerPrefs.GetInt(PREF_DEFAULT_OUT_INTERPOLATION, (int)InterpolationType.Bezier);
